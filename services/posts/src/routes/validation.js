            ...
            switch (req.body.type) {
                case 'file':
                    ...
                    req.checkBody('fileUrl')
                        .matches(URLPATTERN).withMessage('File url is empty or not valid');
                    req.checkBody('fileThumbUrl')
                        .matches(URLPATTERN).withMessage('Thumb url is empty or not valid');
                    break;
                case 'link':
                    req.checkBody('linkType').isIn(['embed', 'file', 'page'])
                        .withMessage('Link type is empty or not valid');
                    req.checkBody('linkUrl').matches(URLPATTERN)
                        .withMessage('Link url is empty or not valid');
                    if (req.body.linkThumbUrl) {
                        req.checkBody('linkThumbUrl').matches(FILEURLPATTERN)
