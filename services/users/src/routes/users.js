...
router
    ...
    .post('/login', users, async (req, res, next) => {
        try {
    ...
    .get('/check', users, async (req, res, next) => {
        try {
    ...
    .get('/profile', ensureAuthenticated, async (req, res, next) => {
        try {
    ...
    .put('/', ensureAuthenticated, users, async (req, res, next) => {
        try {
    ...
    .get('/', users, async (req, res, next) => {
        ...
        try {
            if (query) {
                data = await User.getAllSearched({
